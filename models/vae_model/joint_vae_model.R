...
#y_train       = sie_dat_label[-(1:val_size)]

#= Make tfdatasets for efficieny
# mds_test =         tensor_slices_dataset(list(ds_test, y_test))    |>
#     dataset_map(function(x) tf$one_hot(x[1],4L),
...
# mds_train_1 =         tensor_slices_dataset(ds_train)    |>
...
#                                buffer_size = tf$data$AUTOTUNE)
# 
# mds_train_2 =         tensor_slices_dataset(ds_train)    |>
#     dataset_map(function(x) tf$one_hot(x,4L),
#                 num_parallel_calls = tf$data$AUTOTUNE) |>
#     dataset_map(function(x) list(x,x),
#                 num_parallel_calls = tf$data$AUTOTUNE) |>
...
# 
#  
# mds_val_1  =     tensor_slices_dataset(ds_val)         |>
#     dataset_map(function(x) tf$one_hot(x,4L),
#                 num_parallel_calls = tf$data$AUTOTUNE) |>
#     dataset_map(function(x) list(x,x),
#                 num_parallel_calls = tf$data$AUTOTUNE) |>
...
#                                buffer_size = tf$data$AUTOTUNE)
# 
# mds_val_2  =     tensor_slices_dataset(ds_val)         |>
#     dataset_map(function(x) tf$one_hot(x,4L),
#                 num_parallel_calls = tf$data$AUTOTUNE) |>
#     dataset_map(function(x) list(x,x),
#                 num_parallel_calls = tf$data$AUTOTUNE) |>
